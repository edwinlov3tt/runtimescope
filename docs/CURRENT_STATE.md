...
| Wire-protocol + tool-shape conformance | `npm run conformance` | ✅ **57 / 57 vs Node AND Rust** (gate asserts filters/shapes/codes/derived-fields across HTTP + 26 MCP tools, not just counts). Audit 0002 fully closed. See [`audits/0002-rust-port-audit.md`](./audits/0002-rust-port-audit.md). |
