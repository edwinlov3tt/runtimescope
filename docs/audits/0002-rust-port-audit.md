...
**Status:** Open — **conformance gate fully GREEN (33/33 vs Node AND Rust)** and **Phase D durability + #9 SSRF done.** Remaining: **#7** (session/project metadata) and the **#2/#8 tool-shape sweep** (~57 tools unverified). Green gate ≠ all findings closed — these two remain.
**Date:** 2026-05-29
