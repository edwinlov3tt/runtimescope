...
/**
 * Lifted from `packages/mcp-server/src/scanner/event-builder.ts` (the Node
 * collector, v0.10.13). Only the recon event types now resolve from the
 * sidecar's local `./types.js` instead of `@runtimescope/collector`.
 */
