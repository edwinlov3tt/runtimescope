...
/**
 * Lifted verbatim from `packages/mcp-server/src/scanner/recon-collectors.ts`
 * (the Node collector, v0.10.13). Each collector runs inside Playwright's page
 * context via `page.evaluate`. No RuntimeScope-collector imports — the only
 * dependency is the Playwright `Page` type.
 */
