...
import type { DetectionSignals, DomSignals } from '@runtimescope/extension';

/**
 * Lifted verbatim from `packages/mcp-server/src/scanner/signal-collector.ts`
 * (the Node collector, v0.10.13). Collects DetectionSignals from a Playwright
 * page for the tech-stack detection engine.
 */
